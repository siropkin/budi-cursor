...
- **No cross-surface blending.** The extension always sends `?surface=cursor` and never `?provider=…`. Do not add summary surfaces that show blended multi-IDE totals — ADR-0088 §7 is explicit that scoped surfaces display their own scope only.
